function val = smcB2902A(ic, val, rate)
%Channels
%1 - 'V1' source voltage CH1
%1 - 'V2' source voltage CH2
%2 - 'I1' source current CH1
%2 - 'I2' source current CH2
%3 - 'Vcompl1' voltage compliance CH1
%3 - 'Vcompl2' voltage compliance CH2
%4 - 'Icompl1' current compliance CH1
%4 - 'Icompl2' current compliance CH2
    ...
    switch func% Channels 
        case 1 %V
            switch ic(3); %Operation: 0 for read, 1 for write
                ...
                otherwise
                    error('B2902A driver: Operation not supported');
            end
        case 2 %I
            switch ic(3); %Operation: 0 for read, 1 for write
        ...
        otherwise
            error('B2902A driver: Nonvalid Channel specified');
    end
