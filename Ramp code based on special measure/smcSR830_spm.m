            ...
            case 3
              ...
              case 4
                if ~strcmp(smdata.inst(ic(1)).data.state,'armed')
                    fprintf(smdata.inst(ic(1)).data.inst, 'REST');   % reset buffers
                    smdata.inst(ic(1)).data.currsamp = 0;            % reset read pointer
                    % NOTE: DO NOT touch datadim(15:16,1) here. Keep the npts set by op=5.
